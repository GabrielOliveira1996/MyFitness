                ...
                <div class="card-body mt-4">
                    ...
                    <div class="col-md-12 d-flex justify-content-center">
                        <label for="imageInputId">
                            <a href="{{ route('community.userprofile', ['nickname' => Auth::user()->nickname]) }}">
                                <img id="imageId"
                    ...
                    <div class="col-md-12 d-flex justify-content-center mt-2">
                        <a class="text-decoration-none" href="{{ route('community.userprofile', ['nickname' => Auth::user()->nickname]) }}">
                    ...
                    <div class="row">
                        <a class="btn btn-light text-primary" href="{{ route('community.userprofile', ['nickname' => Auth::user()->nickname]) }}">
                            {{ __('messages.Profile') }}
                        </a>
                    </div>

                    <div class="row">
                        <a class="btn btn-light text-primary" href="{{ route('community.allFollowers', ['nickname' => Auth::user()->nickname]) }}">
