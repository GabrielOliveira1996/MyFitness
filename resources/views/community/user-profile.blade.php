                    ...
                    <div class="card-body">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-9 d-flex justify-content-start">
                                <a class="btn border-0 text-muted">
                                    <small>Curtidas</small>
                                </a>
                            </div>
                            <div class="col-md-3 d-flex justify-content-end">
                                <a class="btn border-0 text-muted">
                                    <small>{{ count($post->comments()->get()); }} Comentários</small>
                                </a>
                            </div>
                            <hr class="col-md-12"/>
                        </div>
                            ...
                            <div id="comments-{{ $post->id }}" class="comments hide-comments">
                                ...
                                @foreach($post->comments()->orderBy('created_at', 'desc')->get() as $comment)
                                    <div class="row mt-3">
                                        ...
                                        <div class="card bg-light p-2 col-md-10" style="border-radius: 0rem 0.7rem 0.7rem 0.7rem">
