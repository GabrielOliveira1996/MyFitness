        ...
        <div class="row">
            ...
            @if(!empty($foods))
                ...
                <div class="col-md-4 p-1 mt-3">
                    <a class="edit-food-btn text-decoration-none text-dark" 
                        ...
                        <div class="card selected-card m-1">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <a href="{{ route('food.delete', ['id' => $food->id]) }}" data-id="{{ $food->id }}" class="btn btn-outline-danger delete-food-button col-md-12">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-trash3 delete-icon" viewBox="0 0 16 16">
