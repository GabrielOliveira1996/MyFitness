                    ...
                    <tr>
                        ...
                        <td>
                            <div class="input-group mb-3">
                                <input type="number" class="form-control" name="quantity_grams" value="{{ $food->quantity_grams; }}">
                        ...
                        <td>
                            <div class="input-group mb-3">
                                <input type="number" class="form-control" name="calories" value="{{ $food->calories; }}">
                                <div class="input-group-append">
                        ...
                        <td>
                            <div class="input-group mb-3">
                                <input type="number" class="form-control" name="carbohydrate" value="{{ $food->carbohydrate; }}">
                                <div class="input-group-append">
                                    <span class="input-group-text" id="basic-addon2">g</span>
                                </div>
                            </div>
                        ...
                        <td>
                            <div class="input-group mb-3">
                                <input type="number" class="form-control" name="protein" value="{{ $food->protein; }}">
                                <div class="input-group-append">
                                    <span class="input-group-text" id="basic-addon2">g</span>
                                </div>
                            </div>
                        ...
                        <td>
                            <div class="input-group mb-3">
                                <input type="number" class="form-control" name="total_fat" value="{{ $food->total_fat; }}">
                                <div class="input-group-append">
                                    <span class="input-group-text" id="basic-addon2">g</span>
                                </div>
                            </div>
                        ...
                        <td>
                            <div class="input-group mb-3">
                                <input type="number" class="form-control" name="saturated_fat" value="{{ $food->saturated_fat; }}">
                                <div class="input-group-append">
                                    <span class="input-group-text" id="basic-addon2">g</span>
                                </div>
                            </div>
                        ...
                        <td>
                            <div class="input-group mb-3">
                                <input type="number" class="form-control" name="trans_fat" value="{{ $food->trans_fat; }}">
                                <div class="input-group-append">
                                    <span class="input-group-text" id="basic-addon2">g</span>
                                </div>
                            </div>
