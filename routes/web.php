...
Route::prefix('food')->group(function () {
    ...
    Route::get('/update-food/{id}', [App\Http\Controllers\FoodController::class, 'updateFoodView'])->name('updateFoodView');
    Route::post('/update-food/{id}', [App\Http\Controllers\FoodController::class, 'updateFood'])->name('updateFood');
    Route::get('/delete-food/{id}', [App\Http\Controllers\FoodController::class, 'deleteFood'])->name('deleteFood');
});
...
Route::prefix('goals')->group(function () {
    ...
    Route::get('/update-food-to-day-goal/{id}', [App\Http\Controllers\GoalsController::class, 'updateFoodToDayGoalView'])->name('updateFoodToDayGoalView');
    Route::post('/update-food-to-day-goal/{id}', [App\Http\Controllers\GoalsController::class, 'updateFoodToDayGoal'])->name('updateFoodToMyDayGoal');
